        ...
        <div key={sectionIndex} className="mb-6">
          {lines.map((line, lineIndex) => {
            ...
            if (lineIndex === 0 && !line.startsWith('-')) {
              return (
                <h2 key={lineIndex} className="text-xl font-semibold mb-4">
                  {line}
                </h2>
              );
            }
            ...
            if (line.startsWith('Day')) {
              return (
                <h3 key={lineIndex} className="text-lg font-medium mt-4 mb-2">
                  {line}
                </h3>
              );
            }
            ...
            if (line.endsWith(':')) {
              return (
                <h4 key={lineIndex} className="font-medium mt-2">
                  {line}
                </h4>
              );
            }
